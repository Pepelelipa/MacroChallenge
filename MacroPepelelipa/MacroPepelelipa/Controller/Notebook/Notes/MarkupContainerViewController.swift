...
internal class MarkupContainerViewController: UIViewController {
    ...
    internal private(set) lazy var formatView: MarkdownFormatView? = {
        ...
        return MarkdownFormatView(frame: CGRect(x: 0, y: 0, width: preferredContentSize.width, height: preferredContentSize.height), owner: textView, viewController: viewController)
    }()
