...
extension UIAlertController {
    ...
    /**
     This method adds a single action to a UIAlertController that presents a log message when clicked, also setting the view's tint color to be the app's main color.
