...
struct TutorialNotesHelper {
    ...
    static func buildIndexText() -> NSAttributedString {
        ...
        index1P10.addAttribute(.underlineColor, value: underlineNumber, range: NSRange(location: 0, length: index1P10.length))
    ...
    static func buildExamplesText() -> NSAttributedString {
        ...
        resultText.append("Examples Second Paragraph 02".localized().toFontWithColor(color: .notebookColors[4], font: paragraphFont))
        resultText.append("Examples Second Paragraph 03".localized().toFontWithColor(font: paragraphFont))
        let example1P04 = "Examples Second Paragraph 04".localized().toFontWithColor(font: paragraphFont)
        example1P04.addAttribute(.underlineColor, value: underlineNumber, range: NSRange(location: 0, length: example1P04.length))
        resultText.append(example1P04)
        resultText.append("Examples Second Paragraph 05".localized().toFontWithColor(font: paragraphFont))
        let example1P06 = "Examples Second Paragraph 06".localized().toFontWithColor(font: paragraphFont)
        example1P06.addAttribute(.underlineColor, value: underlineNumber, range: NSRange(location: 0, length: example1P06.length))
        ...
        resultText.append("Examples Note 2 First Paragraph 02".localized().toFontWithBullet(font: paragraphFont))
        ...
        resultText.append("Examples Note 2 First Paragraph 04".localized().toFontWithBullet(font: paragraphFont))
        resultText.append(breakLine)
        resultText.append(breakLine)
        resultText.append("Examples Note 2 Second Paragraph 01".localized().toFontWithBullet(font: paragraphFont))
        ...
        resultText.append("Examples Note 2 Second Paragraph 03".localized().toFontWithBullet(font: paragraphFont))
        resultText.append(breakLine)
        resultText.append(breakLine)
        resultText.append("Examples Note 2 Second Paragraph 03".localized().toFontWithBullet(font: paragraphFont))
        //  Tentar trocar para H2 ou H3 e fazer isso ser uma nota nova
        resultText.append("Examples Note 2 Third Paragraph H3".localized().toFontWithColor(font: headerFont))
        resultText.append(breakLine)
        resultText.append(breakLine)
        resultText.append("Examples Note 2 Third Paragraph 01".localized().toFontWithBullet(font: paragraphFont))
        resultText.append("Examples Note 2 Third Paragraph 02".localized().toFontWithBullet(font: paragraphItalicFont))
        resultText.append("Examples Note 2 Third Paragraph 03".localized().toFontWithBullet(font: paragraphFont))
        resultText.append("Examples Note 2 Third Paragraph 04".localized().toFontWithBullet(font: paragraphItalicFont))
        resultText.append(breakLine)
        resultText.append(breakLine)
        // Tentar trocar para H2 ou H3 e fazer isso ser uma nota nova
        ...
        resultText.append(breakLine)
        resultText.append(breakLine)
        resultText.append("Examples Note 3 First Paragraph 01".localized().toFontWithBullet(font: paragraphFont))
        resultText.append("Examples Note 3 First Paragraph 02".localized().toFontWithBullet(font: paragraphBoldFont))
        resultText.append("Examples Note 3 First Paragraph 03".localized().toFontWithBullet(font: paragraphFont))
        let example2P04 = "Examples Note 3 First Paragraph 04".localized().toFontWithColor(font: paragraphFont)
        example2P04.addAttribute(.underlineColor, value: underlineNumber, range: NSRange(location: 0, length: example2P04.length))
