...
Right now it relies on **CoreData** technology to store all your data locally in the device, and is also being prepared to go online using **CloudKit**, to ensure **cross-device information.**
